...
path_suffix = [Path('data/heart_rate_membership_functions.csv'), Path('data/systolic_blood_pressure_membership_functions.csv'),
                ...
                Path('data/inspired_oxygen_concentration_membership_functions.csv'), Path('data/spo2_membership_functions.csv')]
...
class MembershipCsvFiles(BaseSettings):
    ...
    path_to_hr_mf: FilePath = Field(default= default_paths[0])
    path_to_sbp: FilePath = Field(default= default_paths[1])
    path_to_rr: FilePath = Field(default= default_paths[2])
    path_to_temp: FilePath = Field(default= default_paths[3])
    path_to_fio2: FilePath = Field(default= default_paths[4])
    path_to_spo2: FilePath = Field(default= default_paths[5])
